	...
	useEffect(() => {
		const fetchCategories = async () => {
			try {
				...
				setLoading(false)
				if (location.pathname === "/product-range") {
			...
			{loading ? (
				...
				<>
					...
					<div className={styles.navDropdown}>
						<Select
							options={[
								{ value: "all-products", label: "Show All Products" },
								...options,
							]}
							onChange={handleSelectChange}
							defaultValue={options[0]}
...
// 		const fetchCategories = async () => {
// 			try {
// 				// Check if categories are in localStorage
// 				const cachedCategories = localStorage.getItem("categories")
// 				const cachedAllProducts = localStorage.getItem("allProducts")

// 				if (cachedCategories && cachedAllProducts) {
// 					setCategories(JSON.parse(cachedCategories))
// 					setAllProducts(JSON.parse(cachedAllProducts))
// 					setLoading(false)
// 					if (location.pathname === "/product-range") {
// 						navigate("all-products")
// 					}
...
// 					// Store categories and products in localStorage
